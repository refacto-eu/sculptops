...
import { executions, playbooks, inventories, vaultPasswords } from "@/lib/db/schema";
...
export default async function ExecutionsPage() {
  ...
  const [executionList, [{ total }], playbookList, inventoryList, vaultList] = await Promise.all([
